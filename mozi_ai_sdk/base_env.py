...
class BaseEnvironment:
    ...
    def __init__(self, ip, port, platform=None, scenario_name=None, simulate_compression=3, duration_interval=15,
                 synchronous=True, app_mode=None, agent_key_event_file=None, request_id=None, side_name=None):
        # 墨子服务端IP
        self.server_ip = ip
        # 墨子服务端端口
        self.aiPort = port
