...
# 添加一个潜艇
red_side.add_submarine('潜艇1', 5, 17.6347078803726, 126.424686148705)
env.step()
sub1 = common.get_obj_by_name(red_side.get_submarines(), '潜艇1')
sub1.set_desired_height(100, 'True')
env.step()
# 获取机场内飞机对象
...
course_list = [(37.0398991935271, 122.958786299026)]
...
ret = aircraft_6.allocate_weapon_to_target(enemy_ship_guid, weapon_db_guid, 1)
print(ret)
