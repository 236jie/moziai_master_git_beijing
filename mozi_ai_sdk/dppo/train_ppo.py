...
# python -m train_ppo --job_name learner
# python -m train_ppo --job_name actor --learner_ip localhost
# 如果和learner在同一台电脑，learner_ip就是localhost，如果不在一台电脑，learner_ip是learner电脑的ip