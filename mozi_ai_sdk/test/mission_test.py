...
class TestMission(TestFramework):
    ...
    def test_get_weapon_infos(self):
        ...
        self.assertTrue(['60x AN/SSQ-53A 型定向频率分析和记录型被动声纳浮标', 'hsfw-dataweapon-00000000001343'] in weapon_infos)
        self.assertTrue(['40x AN/SSQ-62A型定向指令主动声纳浮标', 'hsfw-dataweapon-00000000001888'] in weapon_infos)
        self.assertTrue(['40x AN/SSQ-77A型垂直线列阵（VLAD）被动声纳浮标', 'hsfw-dataweapon-00000000002494'] in weapon_infos)
