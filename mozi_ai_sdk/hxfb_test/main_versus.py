...
# parser.add_argument("--mozi_server_path", type=str, default='E\\Mozi\\MoziServer\\bin')
parser.add_argument("--mozi_server_path", type=str, default=r"E:\Mozi\MoziServer\bin")
...
def rollout(agent,
    ...
    # }
    # 多智能体场景对每个策略，先准备一个“默认动作”向量：
    # 这里直接把标量 0 展平成与动作空间匹配的 ndarray，作为 episode 开始时的 prev_action
    action_init = {
